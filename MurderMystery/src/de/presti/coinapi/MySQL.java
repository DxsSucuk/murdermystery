...
public class MySQL {
	...
	public void createTables() {
		try {
			...
			st = con.prepareStatement("CREATE TABLE IF NOT EXISTS Coins ( id INT AUTO_INCREMENT PRIMARY KEY , PLAYER VARCHAR(40) , COINS VARCHAR(100), time VARCHAR(1000))");
			st.executeUpdate();
